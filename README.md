...
Dưới đây là các script hiện có trong kho lưu trữ. Bạn có thể chạy chúng bằng lệnh `loadstring` tương ứng.
...
Below are the scripts currently available in this repository. Run them using the corresponding loadstring command.
